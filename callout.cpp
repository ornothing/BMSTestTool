...
{
    QPointF anchor = mapFromParent(m_myChart->mapToPosition(this->anchor));
    QRectF rect;
...
void Callout::setText(const QString &text)
{
    ...
    textRect = metrics.boundingRect(QRect(0, 0, 200, 150), Qt::AlignLeft, text);
...
{
    prepareGeometryChange();
    setPos(m_myChart->mapToPosition(anchor) + QPoint(10, -50));
}
